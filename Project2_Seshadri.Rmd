...
While the peanalized regression model is used for feature selection, it may be used for prediction as well. The predictive power was tuned by choosing that proabbaility threshold that maximizes True Positive Rate (TPR) and minimizes False Positive Rate (FPR). The ROC curves for the training and test samples are shown below.

```{r, fig.cap='Lasso ROC curves for test and training data'}
