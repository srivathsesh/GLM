...
1. Expected value = `r 1500*0.65`; Variance = `r 1500*0.65 * (1 - 0.65)` \break
2. Expected employed full time = `r 1500*0.65`  ; Variance = `r 0.55 * 200 * (1-0.55)`\break
   Expected employed part time =  `r 0.15 * 200` ; Variance = `r 0.15 * 200 * (1-0.15)`\break
   Expected unemployed         =  `r 0.10 * 200` ; Variance = `r 0.10 * 200 * (1-0.10)`\break
   Expected non-participants   = `r 0.20 * 200` ; Variance =  `r 0.20 * 200 * (1-0.20)`\break
3. 
```{r}
